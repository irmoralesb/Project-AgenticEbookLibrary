...
def get_metadata_extractor() -> PdfMetadataExtractor:
    """Provide the PDF Metadata Extractor instance."""
    return PdfMetadataExtractor(get_basic_llm_model())
